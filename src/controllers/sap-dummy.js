...
/**
 * Shared paginated summary handler — dipakai oleh GET /single/:projectNo
 * (tanpa identCode) dan GET /check/status/:projectNo.
 */
  ...
  get: {
    by: {
      projectNo: async (req, res) => {
        ...
        try {
          if (identCode) {
            // Detail view: baris mentah difilter per item_code + stage
          ...
          // Tanpa identCode → summary ter-paginasi
