    ...
    get: {
        by: {
            projectNo: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                var stages, _a, projectNo_1, identCode_1, _b, s, p, page, group, pageNum, summaryResponse, response, items_1, error_1, status_1, body;
                ...
                return __generator(this, function (_l) {
                    switch (_l.label) {
                        ...
                        case 1:
                            ...
                            _b = req.query, s = _b.s, p = _b.p, page = _b.page, group = _b.group;
                            // prettier-ignore
                            if (!projectNo_1)
                                return [2 /*return*/, res.status(400).json({ message: "Invalid Parameters" })];
                            if (!!identCode_1) return [3 /*break*/, 3];
                            pageNum = Math.max(1, parseInt(page !== null && page !== void 0 ? page : "1", 10) || 1);
                            return [4 /*yield*/, sap_dummy_1.default.get.summary.projectNo(projectNo_1, pageNum, s !== null && s !== void 0 ? s : "", group !== null && group !== void 0 ? group : "")];
                        case 2:
                            summaryResponse = _l.sent();
                            if (!summaryResponse.success) {
                                return [2 /*return*/, res.status(502).json(summaryResponse)];
                            }
                            return [2 /*return*/, res.status(200).json({
                                    success: true,
                                    last_update: (_c = summaryResponse.last_update) !== null && _c !== void 0 ? _c : "-",
                                    groups: (_d = summaryResponse.groups) !== null && _d !== void 0 ? _d : [],
                                    data: summaryResponse.data,
                                    pagination: summaryResponse.pagination,
                                })];
                        case 3:
                            if (!p) {
                                return [2 /*return*/, res.status(400).json({ message: "Invalid Parameters: p (stage) is required when identCode is provided" })];
                            }
                        ...
                        case 4:
                            ...
                            response.data.data[p]
                                ...
                                .forEach(function (r) {
                                var _a, _b;
                                items_1.set(r.id, __assign(__assign({}, r), { id: r.item_code, group: (_a = r.group) !== null && _a !== void 0 ? _a : null, description: (_b = r.item_description) !== null && _b !== void 0 ? _b : null, project_no: projectNo_1, input_date: r.doc_date
                            ...
                            return [2 /*return*/, res.status(200).json({
                                    success: true,
                                    last_update: (_f = (_e = response.data) === null || _e === void 0 ? void 0 : _e.last_update) !== null && _f !== void 0 ? _f : "-",
                                    data: Array.from(items_1.values()),
                                })];
                        case 5:
                            error_1 = _l.sent();
                            status_1 = (_h = (_g = error_1 === null || error_1 === void 0 ? void 0 : error_1.status) !== null && _g !== void 0 ? _g : error_1 === null || error_1 === void 0 ? void 0 : error_1.statusCode) !== null && _h !== void 0 ? _h : 500;
                            body = (_k = (_j = error_1 === null || error_1 === void 0 ? void 0 : error_1.data) !== null && _j !== void 0 ? _j : error_1 === null || error_1 === void 0 ? void 0 : error_1.message) !== null && _k !== void 0 ? _k : error_1;
                            return [2 /*return*/, res.status(status_1).json(body)];
        ...
        status: {
            projectNo: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                var stages, projectNo, s, response_1, items_2, error_2;
                var _a, _b;
