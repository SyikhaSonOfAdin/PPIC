...
router.post(
  ...
  projectControllers.edit.all,
);
router.post(
  "/edit/d/deliver",
  jwtServices.verifyToken.byHeader,
  privilege.hasPrivilege("01987839-d26e-7772-9ed6-ccd8de97ea37"),
  projectControllers.edit.deliver,
);
router.post(
  "/delete",
  jwtServices.verifyToken.byHeader,
...
router.get(
  "/get/:companyId",
  jwtServices.verifyToken.byHeader,
  projectControllers.get.all,
);
router.get(
  "/get/:companyId/:projectId",
  jwtServices.verifyToken.byHeader,
  projectControllers.get.onlyOne,
);
router.get(
  "/get/s/d/:companyId",
  jwtServices.verifyToken.byHeader,
  projectControllers.get.summary,
);
router.get(
  "/get/download/plans-and-actual/:companyId/:year",
  jwtServices.verifyToken.byHeader,
  projectControllers.get.download.plans_and_actual,
);
