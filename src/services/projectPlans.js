        ...
        all: function (projectId, connection) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.trys.push([3, 5, 6, 7]);
                        return [4 /*yield*/, CONNECTION.query(projectPlans_1.plansQuerys.delete.all, [projectId])];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 5:
        ...
        onlyOne: function (plansId, connection) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.trys.push([3, 5, 6, 7]);
                        return [4 /*yield*/, CONNECTION.query(projectPlans_1.plansQuerys.delete.onlyOne, [plansId])];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 5:
