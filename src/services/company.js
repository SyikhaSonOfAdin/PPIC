        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    id = (0, uuid_1.v7)();
                    return [4 /*yield*/, CONNECTIONS.query(company_1.companyQuerys.insert, [id, name])];
                case 4:
                    _b.sent();
                    return [2 /*return*/, id];
                case 5:
        ...
        name: function (id, name, connection) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.trys.push([3, 5, 6, 7]);
                        return [4 /*yield*/, CONNECTION.query(company_1.companyQuerys.update.name, [name, id])];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 5:
        ...
        status: function (id, status, connection) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.trys.push([3, 5, 6, 7]);
                        return [4 /*yield*/, CONNECTION.query(company_1.companyQuerys.update.status, [status, id])];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 5:
    ...
    delete: function (id, connection) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    _b.trys.push([3, 5, 6, 7]);
                    return [4 /*yield*/, CONNECTIONS.query(company_1.companyQuerys.delete, [id])];
                case 4:
                    _b.sent();
                    return [3 /*break*/, 7];
                case 5:
