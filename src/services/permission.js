...
exports.permissionServices = {
    ...
    add: function (userId, permissionId, granted, connection) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    _b.trys.push([3, 5, 6, 7]);
                    id = (0, uuid_1.v7)();
                    return [4 /*yield*/, CONNECTION.query(permissions_1.userPermissionsQuery.insert, [id, userId, permissionId, granted])];
                case 4:
                    _b.sent();
                    return [2 /*return*/, id];
                case 5:
