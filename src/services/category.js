...
exports.categoryServices = {
    add: function (companyId, userId, name, description, unitOfMeasurement, connection) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    edit: function (categoryId, name, description, unitOfMeasurement, userId, connection) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    delete: {
        onlyOne: function (categoryId, connection) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.trys.push([3, 5, 6, 7]);
                        return [4 /*yield*/, CONNECTION.query(category_1.categoryQuerys.delete.onlyOne, [categoryId])];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 5:
        ...
        all: function (companyId, connection) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.trys.push([3, 5, 6, 7]);
                        return [4 /*yield*/, CONNECTION.query(category_1.categoryQuerys.select.all, [companyId])];
                    case 4:
                        data = (_b.sent())[0];
        ...
        onlyOne: function (rowId, connection) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.trys.push([3, 5, 6, 7]);
                        return [4 /*yield*/, CONNECTION.query(category_1.categoryQuerys.select.onlyOne, [rowId])];
                    case 4:
                        data = (_b.sent())[0];
                        return [2 /*return*/, data];
                    case 5:
