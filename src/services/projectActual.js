        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    id = (0, uuid_1.v7)();
                    return [4 /*yield*/, CONNECTION.query(projectActual_1.actualQuerys.insert, [id, projectId, userId, start, end, amount])];
                case 4:
                    _b.sent();
                    return [2 /*return*/, id];
                case 5:
    ...
    get: function (projectId, connection) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    _b.trys.push([3, 5, 6, 7]);
                    return [4 /*yield*/, CONNECTION.query(projectActual_1.actualQuerys.select, [projectId])];
                case 4:
                    data = (_b.sent())[0];
