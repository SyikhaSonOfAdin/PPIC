...
exports.projectServices = {
    add: function (companyId, categoryId, projectNo, client, userId, connection) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        onlyOne: function (projectId, connection) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.trys.push([3, 5, 6, 7]);
                        return [4 /*yield*/, CONNECTION.query(project_1.projectQuerys.select.onlyOne, [projectId])];
                    case 4:
                        data = (_b.sent())[0];
        ...
        byCategoryId: function (categoryId, connection) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.trys.push([3, 5, 6, 7]);
                        return [4 /*yield*/, CONNECTION.query(project_1.projectQuerys.select.byCatgoeryId, [categoryId])];
                    case 4:
                        data = (_b.sent())[0];
                        return [2 /*return*/, data];
                    case 5:
